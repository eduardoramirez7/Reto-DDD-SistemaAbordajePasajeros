...
public class AsignarRecepcionista implements Command {
    ...
    public AsignarRecepcionista(CheckInId checkInId, RecepcionistaId recepcionistaId, NombreRecepcionista nombreRecepcionista) {
